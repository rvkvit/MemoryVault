...
def upgrade() -> None:
    ...
    op.create_table(
        ...
        sa.Column("show_guestbook", sa.Boolean, nullable=False, server_default="1"),
        sa.Column("show_timeline", sa.Boolean, nullable=False, server_default="1"),
        sa.Column("show_photos", sa.Boolean, nullable=False, server_default="1"),
        sa.Column("show_video", sa.Boolean, nullable=False, server_default="0"),
